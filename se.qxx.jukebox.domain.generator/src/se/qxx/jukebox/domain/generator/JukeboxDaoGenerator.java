package se.qxx.jukebox.domain.generator;
    ...
    public static void main(String[] args) throws Exception {
    	if (args.length > 0) {
    		...
    		if (f.isDirectory() && f.exists()) {
		        Schema schema = new Schema(3, "se.qxx.jukebox.domain.JukeboxDomain");
		        schema.setSimpleFilename(true);
		        schema.setDefaultJavaPackageDao("se.qxx.jukebox.domain.dao");
